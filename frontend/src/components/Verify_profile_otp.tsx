...
export function VerifyProfileOTP() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/verify_profile_otp", {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <h2 className="text-3xl font-bold text-center mb-2">Verify Profile OTP</h2>
          <p className="text-center text-gray-600 mb-8">
            Enter OTP sent to your new email & phone
          </p>
